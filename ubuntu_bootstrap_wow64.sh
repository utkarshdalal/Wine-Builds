...
apt-get -y install python3-pip libxcb-xkb-dev libfontconfig-dev libgl-dev libavcodec-dev=7:4.4.2-0ubuntu0.22.04.1 libavformat-dev=7:4.4.2-0ubuntu0.22.04.1 libavutil-dev=7:4.4.2-0ubuntu0.22.04.1 libswscale-dev=7:4.4.2-0ubuntu0.22.04.1 libswresample-dev=7:4.4.2-0ubuntu0.22.04.1 libavfilter-dev=7:4.4.2-0ubuntu0.22.04.1
apt-mark hold libavcodec-dev libavformat-dev libavutil-dev libswscale-dev libswresample-dev libavfilter-dev
