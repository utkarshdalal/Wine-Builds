...
if [ "${EXPERIMENTAL_WOW64}" = "true" ]; then
   ...
   export CFLAGS_X64="-march=sandybridge -mtune=sandybridge -pthreads -O2 -pipe -mavx -ffast-math -funroll-loops -ftree-vectorize -fgraphite-identity -floop-nest-optimize"
